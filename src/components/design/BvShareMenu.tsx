...
import { shareToInstagramStory } from '@/utils/instagram-story'
...
export function BvShareMenu({
  ...
  const shareOptions = [
    ...
    },
    {
      ...
      action: async () => {
        setIsOpen(false)
        toast.loading('Criando story personalizado...', { id: 'instagram-story' })

        try {
          const result = await shareToInstagramStory({
            ubsName,
            neighborhood: neighborhood || 'Baixada Santista',
            shareUrl,
            distanceInKm,
          })
          ...
          if (result.success) {
            ...
            toast.error(result.message, { id: 'instagram-story' })
          }
        } catch (error) {
          console.error('Erro ao criar story:', error)
          toast.error('Erro ao criar story. Tente novamente.', { id: 'instagram-story' })
        }
      },
    },
    {
